...
static void setup_score_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(score_layer, get_background_color());
    text_layer_set_text_color(score_layer, get_foreground_color());
...
static void load_mood_window(Window *window)
{
    ...
    expose_ui(window, action_bar, icon_layer, score_layer);
