...
static void setup_alarm_window_action_bar_layer(Layer *window_layer, GRect bounds)
{
    ...
    action_bar_layer_set_background_color(alarm_window_action_bar_layer, config_get_foreground_color());
...
static void setup_alarm_title_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(alarm_title_layer, config_get_background_color());
    text_layer_set_text_color(alarm_title_layer, config_get_foreground_color());
...
static void setup_alarm_time_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(alarm_time_layer, config_get_background_color());
    text_layer_set_text_color(alarm_time_layer, config_get_foreground_color());
...
static void setup_alarm_snooze_time_layer(Layer *window_layer, GRect bounds)
{
    ...
    text_layer_set_background_color(snooze_time_layer, config_get_background_color());
    text_layer_set_text_color(snooze_time_layer, config_get_foreground_color());
